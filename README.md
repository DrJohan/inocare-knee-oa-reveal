...
Tap the hamburger menu button in the top-right corner to open the presentation menu. The menu remains available when the slide deck is full screen and contains:
...
Presenter view has its own hamburger menu. Use it to make the presenter window full screen or return to the main slides. If Safari blocks presenter view, allow pop-ups for the site and tap the option again.

## Chalkboard and live drawing

The drawing section inside the hamburger menu provides four controls:
